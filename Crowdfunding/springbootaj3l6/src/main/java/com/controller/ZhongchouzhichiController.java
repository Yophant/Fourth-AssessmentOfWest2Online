...
public class ZhongchouzhichiController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,ZhongchouzhichiEntity zhongchouzhichi,
		HttpServletRequest request){
		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("qiye")) {
			zhongchouzhichi.setQiyezhanghao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("yonghu")) {
			zhongchouzhichi.setYonghuming((String)request.getSession().getAttribute("username"));
		}
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,ZhongchouzhichiEntity zhongchouzhichi, 
		HttpServletRequest request){
        EntityWrapper<ZhongchouzhichiEntity> ew = new EntityWrapper<ZhongchouzhichiEntity>();
		PageUtils page = zhongchouzhichiService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, zhongchouzhichi), params), params));
        return R.ok().put("data", page);
